    ...
    return (
        ...
        <div className='container'>
            <div className='admin-cards'>
                ...
                <div className='single-card'>
                    <Link to='/add-item'> <div className='icon-img'><img src={additem} /></div> <p>Add Item</p></Link>
                </div>
...

                {
                    paypal.map(e =>
                        <div className='single-card'>
                            <Link to={`/paypal-email/${e._id}`}> <div className='icon-img'><img src={payment} /></div> <p> Payment Option</p></Link>
                        </div>
